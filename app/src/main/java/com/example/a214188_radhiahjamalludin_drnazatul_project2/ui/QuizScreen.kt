        ...
        Dialog(onDismissRequest = { }) {
            Card(
                ...
                Column(
                    ...
                    CircularProgressIndicator(color = UnifiedButtonColor)
                    Spacer(Modifier.height(16.dp))
                    Text("Saving your results...", color = WhiteText)
                }
            }
        }
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                ...
                enabled = !isSubmitting && selectedAnswer1 != -1 && selectedAnswer2 != -1 && selectedAnswer3 != -1
            ) {
