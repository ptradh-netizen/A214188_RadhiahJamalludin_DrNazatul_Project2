        ...
        Column(
            ...
            LazyColumn(
                ...
                items(history.reversed()) { result ->
                    // Find the icon based on courseId or courseName
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            // Display course-specific icon instead of generic Score icon
                            Surface(
            ...
            Button(
                ...
                Text("Go to Profile", style = MaterialTheme.typography.labelLarge)
            }
        }
    }
}
